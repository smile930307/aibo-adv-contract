...
contract EggNft is ERC721, Ownable {
    ...
    bytes32 public merkleOgListRoot = 0x186cc0caf42bf47adf83586ee3f46431396ab928f3777e1c776b3f068726172c;
    bytes32 public merkleWlListRoot = 0x186cc0caf42bf47adf83586ee3f46431396ab928f3777e1c776b3f068726172c;
    ...
    function getUserWhiteListed() external view returns (uint256) {
        uint256 value;
        if (mintType == 0) {
            require(_ogList[msg.sender] == true, "Not registry");
            value = 1;
        } else if (mintType == 1) {
            require(_wlList[msg.sender] == true, "Not registry");
            value = 2;
        } else {
            value = 3;
        }
